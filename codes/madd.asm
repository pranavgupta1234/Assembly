...
%include "io.mac"                                                    ; header library for basic I/O
...
.DATA
  ...
  msg1: db "Enter the number of rows in the matrix : ",0
  msg_size1: equ $-msg1
  msg2:  db "Enter the elements one by one(row by row) : ",0
  msg_size2: equ $-msg2
  msg3: db "Enter the number of columns in the matrix : ",0
  msg_size3: equ $-msg3
  ...
  msg_matrix3: db "Addition matrix : ", 10
